...
C["media"] = {
	...
	["pxfontHeader"] = "Interface\\Addons\\ViksUI\\Media\\Font\\pixel.ttf", 		-- DataText Font for Headers. Used on Top Line
	...
	["border_color"] = { 0.29, 0.29, 0.32, 1}, 												-- border color of Viks UI panels
...
C["general"] = {
	...
	["uiscale"] = 0.66,							-- Your value(between 0.64 and 1) if "auto_scale" is disable
...
C["position"] = {
	...
	["bn_popup"] = {"TOPLEFT", LChat, "TOPLEFT", 10, 0},							-- Battle.net popup
	...
	["right_bars"] = {"BOTTOMRIGHT", UIParent, "BOTTOMRIGHT", -4, 360},				-- Right bars
	["pet_horizontal"] = {"BOTTOMRIGHT", UIParent, "BOTTOM", -344, 298},			-- Horizontal pet bar
