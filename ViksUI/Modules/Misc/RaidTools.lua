...
ShowHideRaid:SetPoint("CENTER", RIGHTChatline, "CENTER", 0, 0)
...
RaidToolsText:SetPoint("RIGHT", RIGHTChatline, "RIGHT", -150, 0)
...
RIGHTChatline.iconmiddle:SetPoint("RIGHT", RaidToolsText, "LEFT", -4, 0)
...
ShowHideTools:SetPoint("RIGHT", RIGHTChatline, "RIGHT", 0, 0)
ShowHideTools:SetAttribute("macrotext1", "/config")
ShowHideTools:SetAlpha(0)

local ToolsText = RIGHTChatline:CreateFontString(nil, "OVERLAY")
ToolsText:SetFontObject(CombatLogFont)
ToolsText:SetPoint("RIGHT", RIGHTChatline, "RIGHT", -28, 0)
...
RIGHTChatline.iconright:SetPoint("RIGHT", RIGHTChatline, "RIGHT", -12, 0)
...
raidtoolbg:SetPoint("TOP", RChatTab, "TOP", 1, -26)
